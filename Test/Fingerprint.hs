...
tests =
    ...
    , TestCase $ assertEqual "Read older style fingerprint" (Just fingerprint0a) (readUpstreamFingerprint "\"Dir \\\"/tmp/foo\\\"\" 1.0 ghc=7.8.20140710-2+seereason1~precise1")
    ...
    , let m = "\"Proc (DebDir (Cd \\\"Cabal\\\" (Git \\\"https://github.com/ghcjs/cabal\\\" [Branch \\\"ghcjs\\\"])) (Git \\\"https://github.com/ddssff/cabal-ghcjs-debian\\\" []))\""
      ...
      in
      TestCase $ assertEqual "Fingerprint Test 2" (Just fingerprint1) (readUpstreamFingerprint (intercalate " " [m, a, v, builddeps]))
